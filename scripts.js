    ...
    */
    const cargarTabla = (misProductos) => {
        ...
        misProductos.forEach(product => {
            ...
            //Estilo para el botón de más cantidad
            masButton.classList.add("btn", "btn-sm", "rounded", "me-2");
            ...
            //Estilo para el botón de menos cantidad
            menosButton.classList.add("btn", "btn-sm", "rounded", "me-2");
            ...
            //Estilo para el recuadro de la cantidad de producto
            cantidadInput.type = "number";
            cantidadInput.classList.add("form-control", "form-control-sm", "rounded");
            cantidadInput.style.width = "3em";
            cantidadInput.value = unidades;
    ...
    //API modificada de acuerdo con enunciado
    fetch("https://jsonblob.com/api/1422891732672110592")
